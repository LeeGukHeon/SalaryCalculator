...
function Home() {
  ...
  const featuredArticles = [
    {
      to: "/articles/2026-insurance-rate-changes",
      title: "2026년 달라진 4대보험 요율 완벽 정리",
      summary: "국민연금·건강보험·장기요양보험 변경폭과 실수령액 영향을 연봉 구간별로 정리했습니다.",
    },
    {
      to: "/articles/2026-year-end-tax-guide",
      title: "2026년 연말정산 완벽 가이드",
      summary: "자녀·교육·청약·기부금 공제 핵심과 연말 실전 체크리스트를 제공합니다.",
    },
    {
      to: "/articles/5-ways-to-increase-take-home-pay",
      title: "실수령액 늘리는 5가지 방법",
      summary: "비과세·카드전략·연금저축·청년감면 등 실전 절세 액션을 단계별로 안내합니다.",
    },
  ];
  ...
  return (
    <div className="container">
      ...
      <section className="blog-section" style={{ marginTop: "50px" }}>
        <h2 style={{ textAlign: "center", marginBottom: "12px" }}>💡 연봉 정보 아카이브</h2>
        <p className="description" style={{ textAlign: "center", marginBottom: "24px" }}>
          홈 화면에 몰려 있던 심층 콘텐츠를 개별 문서 URL로 분리했습니다.
        </p>
        ...
        <div style={{ display: "grid", gap: "14px" }}>
          {featuredArticles.map((article) => (
            ...
            >
              <h3 style={{ marginBottom: "8px", color: "#1f2937" }}>{article.title}</h3>
              <p style={{ marginBottom: "12px", color: "#4b5563", lineHeight: "1.6" }}>
                {article.summary}
              </p>
              <Link to={article.to} style={{ color: "#2563eb", fontWeight: 700 }}>
                자세히 보기 →
              </Link>
            </article>
          ))}
      ...
      <section className="update-log-section">
        ...
        <div className="update-log-item">
          ...
          <p>심층 콘텐츠를 개별 문서 URL로 분리하고 구조화 데이터를 확장했습니다.</p>
        </div>
        <div className="update-log-item">
        ...
        <p className="help-text">최종 검토일: 2026-02-18 · 다음 정기 점검: 매월 1주차</p>
      </section>
